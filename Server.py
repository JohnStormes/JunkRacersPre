...
def threadedClient(conn, player_ID):
    ...
    while True:
        # make try catch when using on actual server
        #try:
        ...
        # change team
        elif decision_value == helper.CHANGE_TEAM:
            lobbies[lobby_ID_index].changeTeam(player_received, team_change_value)
